            ...
            <div className="flex justify-center">
                <div className=" mx-[10px] md:mx-[60px] lg:mx-[200px] w-full">
                    <div className="bg-[#ffb4a7] px-[20px] md:px-[40px] py-[30px] rounded-[30px] text-center" >
                        ...
                        <div className="font-bold text-[22px] md:text-[28px] leading-none  md:leading-normal mt-[10px] md:mt-0 "><span>Registration Fee - ₹50 per individual</span></div>
            ...
            <div className="flex justify-center mt-[30px] md:mt-[50px]">
                <div className="flex justify-center mt-[20px]">
                    <div className='text-center  mb-[50px]'>
                        <div className=' mb-[10px]'><span className='font-bold  text-[20px]'>
                            ABOUT</span></div>
                        <div className='mx-[20px] md:mx-[120px] xl:mx-[220px] '><span className='text-[17px] font-semibold'> Hands on experience with the right proportions of materials and
                            facilitate yourself for industrial exposure and resolve queries
                            with experts.</span></div>
                        <div className='mt-[20px]'><span className='text-[17px] font-semibold'>Certificates will be provided</span></div>
                    </div>
                </div>
            </div>
