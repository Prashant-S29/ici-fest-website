...
const materialData = [
    { material: 'A4 Size Sheets', quantity: '2-3' },
            ...
            <div className="flex justify-center">
                <div className=" mx-[10px] md:mx-[60px] lg:mx-[200px] w-full">
                    <div className="bg-[#ffb4a7] px-[20px] md:px-[40px] py-[30px] rounded-[30px] text-center" >
                        <div><span className="font-extrabold text-[38px] md:text-[50px] uppercase" >ART OF PERSUASION</span></div>
                        <div className='text-center mb-[10px]'><span className='font-semibold text-[18px] uppercase'>Essay Writing Competition</span></div>
                ...
                <div>
                    ...
                    <div className="flex justify-center mt-[20px]">
                        <div className={activeButton === 0 ? 'active-div' : 'deactive-div'}>
                            <div className='text-center  mb-[50px]'>
                                ...
                                <div className='mx-[20px] md:mx-[120px] xl:mx-[220px] '><span className='text-[17px] font-semibold'>It's an essay writing. Participants will have to write an essay on the  provided topic .</span></div>
                            </div>
                            <div className='text-center  mb-[50px]'>
                                <div className=' mb-[10px] underline'><span className='font-bold  text-[20px]'>PARTICIPATION</span></div>
                                <div><span className='font-semibold text-[17px]'>Individual Participant.</span></div>
                            </div>
                            <div className='text-center  mb-[50px]'>
                                <div className=' mb-[10px] '><span className='font-bold  text-[20px] underline  '>PROBLEM STATEMENT</span></div>
                                <div className='mx-[20px] md:mx-[120px] xl:mx-[220px] '><span className='text-[18px] font-bold '> Topic - "Beyond Blueprints: Integrating multidisciplinary knowledge into civil engineering".
                                </span></div>
                                <div><span className='font-semibold'>Word Limit: </span><span> 600 - 750 words</span></div>
                            </div>
                            <div className='text-center  mb-[50px]'>
                    ...
                    <div className={`${activeButton === 1 ? 'active-div' : 'deactive-div'} text-[18px] `}>
                        <div className='flex justify-center mt-[10px] text-left md:text-center mx-[10px]'>
                            <div>
                                <div><span className='font-bold'>Writing Essay</span></div>
                                <div><span>Participants will be given <b>1 hour </b>to wite their essay.</span></div>

                                <div className='mt-[10px]'><span className='font-bold'>Reviewing and Finalzing Winners</span></div>
                                <div><span>Your essay will be judged on word limit and grammer.</span></div>
                            </div>
                        </div>
                    </div>
                    <div className={`${activeButton === 2 ? 'active-div' : 'deactive-div'} mx-[20px]`}>
                        ...
                        <div className='flex justify-center text-[17px] text-center'>
                            <div>
                                <div className='mt-[10px]'><span><b>Grammer and Word Limit</b></span></div>
                                <div><span>Your essay will be judged on word limit and grammer.</span></div>
                            </div>
                        </div>
                    </div>
