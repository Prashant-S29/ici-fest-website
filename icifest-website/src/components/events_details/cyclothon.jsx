            ...
            <div className="flex justify-center">
                <div className=" mx-[10px] md:mx-[60px] lg:mx-[200px] w-full">
                    <div className="bg-[#ffb4a7] px-[40px] py-[30px] rounded-[30px] text-center" >
                        <div><span className="font-extrabold text-[38px] md:text-[50px] leading-tight md:leading-normal" >CYCLOTHON & WALKOTHON</span></div>
                        ...
                        <div className='flex justify-center mt-[20px]'>
                            <div className='bg-white rounded-[50px] flex justify-center gap-[30px] p-[5px]'>
                                <div><Link to='/cement-pottery' ><img src={next} className='w-[25px] md:w-[30px]  rotate-180  ' /></Link></div>
                                <div><Link to='/workshop' ><img src={next} className='w-[25px] md:w-[30px]    ' /></Link></div>
                            </div>
                        </div>
                    </div>
                </div>
