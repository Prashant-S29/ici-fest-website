            ...
            <div className="flex justify-center">
                <div className="mx-[200px] w-full">
                    <div className="bg-[#ff9f8e] px-[40px] py-[30px] rounded-[30px] text-center" >
                        <div><span className="font-extrabold text-[50px]" >CYCLOTHON & WALKATHON</span></div>
                        <div className="flex justify-center"><div className="w-[100px] h-[4px] bg-[#ff583e]  " /></div>
                        <div className="mt-[15px] font-bold text-[18px]">
                            <div><span>Date - 16<sup>th </sup>September 2023</span></div>
                            <div><span>Time - 10:00 AM onwards</span></div>
                        </div>
                        <div className="font-bold text-[28px]"><span>Registration Fee - ₹200 per team</span></div>
                    </div>
                </div>
            </div>
