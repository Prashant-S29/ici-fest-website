...
const Counter = () => {
    return (
        <>
            <div className="mt-[30px] md:mt-[50px] text-[30px] md:text-[36px] font-extrabold text-center"><span>FEST'<span className="text-[#ff583e]">22 </span>Stats</span></div>
            ...
            <div className=" flex flex-wrap justify-evenly mb-[30px] mt-[40px]">
                ...
                <div className="flex bg-[#e5e5e5]  rounded-[20px] py-[15px] px-[25px] text-left max-[320px]:min-w-[100px] min-w-[140px]">
                    <div>
                        <div className=""><span className="text-[24px] lg:text-[36px] font-extrabold text-[#ff583e] leading-none" >
                            10+</span></div>
                        <div className=""><span className="text-[16px] lg:text-[22px] font-semibold text-black leading-5  " >Events</span></div>
                    </div>
                </div>
                ...
                <div className="flex  bg-[#e5e5e5] max-[320px]:mt-[20px]  mt-[20px] md:mt-0 rounded-[20px] py-[15px] px-[25px] text-left max-[320px]:min-w-[100px] min-w-[140px]">
                    <div>
                        <div className=""><span className="text-[24px] lg:text-[36px] font-extrabold text-[#ff583e] leading-none" >3000+</span></div>
                        <div className=""><span className="text-[16px] lg:text-[22px] font-semibold text-black leading-5  " >Footfall</span></div>
                    </div>
                </div>
